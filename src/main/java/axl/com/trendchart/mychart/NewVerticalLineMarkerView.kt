 ...
 * Time: 下午6:53
 */
class NewVerticalLineMarkerView(context: Context?, layoutResource: Int) : MarkerView(context, layoutResource) {
    ...
    override fun draw(canvas: Canvas?) {
        ...
        canvas?.drawRect(highlight!!.xPx , 0f, highlight!!.xPx + context.dip(0.5f).toFloat(), viewHeight.toFloat(), paint)
    }
